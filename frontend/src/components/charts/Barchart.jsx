...
export default function Barchart() {
  ...
  return (
    <div className=" bg-white rounded w-[380px] flex flex-column justify-between h-[300px] p-3 my-2 px-4">
      <div className="relative">
        <h2 className={`${h3}`}>Bar Chart</h2>
        <EllipsisHorizontalIcon className="h-8 w-8 absolute top-0 right-[-5px]" />
      </div>
